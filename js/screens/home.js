...
export function renderHome(container, navigate) {
  ...
  container.innerHTML = `
      ...
      ${todayWorkoutDay
        ...
        : `<div class="card rest-day-card">
            ...
            <div style="margin-top:16px">
              <button class="btn-primary" id="start-workout-btn" style="background:var(--surface-raised);color:var(--text-muted);border:1px solid var(--border)">
    ...
    ${isIos() && !isInStandaloneMode() ? `
      <div class="section">
        <div class="card" style="border-color:var(--accent-blue);background:rgba(61,142,248,0.06)">
          ...
          <div style="font-size:0.78rem;color:var(--text-muted);line-height:1.6">
            Tap the <strong style="color:var(--text)">Share</strong> button in Safari, then tap <strong style="color:var(--text)">"Add to Home Screen"</strong> to install this app.
          </div>
        </div>
      </div>
    ` : ''}
